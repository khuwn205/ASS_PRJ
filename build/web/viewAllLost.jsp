...
<head>
    <meta charset="UTF-8">
    <title>Tất cả tin báo mất đồ</title>
    <style>
...
<body>
    ...
    <table>
        ...
        <c:forEach var="it" items="${allLostItems}" varStatus="st">
            <tr>
                <td>${st.index + 1}</td>
                <td>${it.title}</td>
        ...
        <c:if test="${empty allLostItems}">
            <tr><td colspan="5">Chưa có tin báo mất nào.</td></tr>
        </c:if>
    </table>
</body>
</html>
