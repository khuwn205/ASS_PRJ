            ...
            <table border="1" width="100%">
                <tr>
                    <td width="30%" valign="top">
                        ...
                        - <a href="manage_locations">Quản lý Vị trí (Locations)</a>
                    </td>
                    <td valign="top">
                        <b>Thống kê nhanh</b><br><br>
                        - Tổng số người dùng: 150<br>
                        - Tổng số đồ đang thất lạc: 45
                    </td>
                </tr>
            </table>
        </c:when>
            ...
            <table border="1" width="100%">
                <tr>
                    <td width="30%" valign="top">
                        ...
                        - <a href="report-lost">Báo mất đồ (Lost)</a><br>
                        - <a href="report_found">Báo nhặt được đồ (Found)</a><br>
                        - <a href="my-items">Các tin tôi đã đăng</a><br>
